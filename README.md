...
> [!WARNING]   
> Бот более не поддерживается из-за утраты актуальности **Stable Diffusion XL Flash** и [блокировки](https://github.com/yihong0618/klingCreator/issues/32) пользовательского API **Kling AI**.
